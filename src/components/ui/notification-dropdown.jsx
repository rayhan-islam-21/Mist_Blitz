      ...
      <DropdownMenu
        ...
        {notifications.length > 0 && (
          <div className="px-4 py-3 border-t border-zinc-200 dark:border-zinc-700">
            <button
              className="w-full flex items-center justify-center space-x-2 text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
