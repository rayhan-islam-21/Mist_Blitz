      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative group">
            ...
            <div className="relative bg-gray-800 rounded-2xl overflow-hidden border border-white/10">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                <span className="text-blue-400 font-mono text-sm tracking-widest uppercase">Project Identity</span>
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-left">
            <div className="inline-block px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-xs font-bold uppercase tracking-widest">
              Establishment 2024
            </div>
            ...
            <div className="space-y-4 text-gray-400 text-lg leading-relaxed">
              ...
              <p>
                Founded in <span className="text-blue-500 font-mono">April 2024</span>, our team embarked on a mission 
