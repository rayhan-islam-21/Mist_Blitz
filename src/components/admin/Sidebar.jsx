            ...
            <>
              <div className="flex items-center p-3 rounded-xl bg-white border border-gray-200 shadow-sm">
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <p className="text-[10px] text-slate-500 uppercase">{user?.admindata?.role}</p>
                </div>
              </div>

              <button
                onClick={() => setLogoutModalOpen(true)}
                className="flex items-center justify-center w-full gap-2 px-4 py-2.5 text-sm font-semibold text-red-600 hover:bg-red-50 rounded-xl"
              >
      ...
      <Dialog open={logoutModalOpen} onOpenChange={setLogoutModalOpen}>
        <DialogContent className="sm:max-w-md p-0">
          <div className="p-6 space-y-4">
            ...
            <button onClick={handleConfirmLogout} className="w-full bg-red-600 text-white py-2">
              Logout
            </button>
          </div>
        </DialogContent>
